...
path("admin-allorders/", AdminOrderListView.as_view(), name="adminorderlist"),
path("admin-order/<int:pk>-change", AdminOrderStatusChangeView.as_view(), name="adminorderstatus"),
