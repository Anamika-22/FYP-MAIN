...
#             return redirect("ecommerce:customerlogin")
#         return super(). dispatch(request, *args, **kwargs)
...
class ManageCartView(EcomMixin, View):
    def get(self, request, *args, **kwargs):
        ...
        if action == "inc":
            ...
            pass
        return redirect("ecommerce:mycart")
...
class CheckoutView(EcomMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        if cart_id:
            ...
            if pm == "Khalti":
                return redirect(reverse("ecommerce:khaltirequest") + "?o_id=" + str(order.id))
...
class AdminLoginView(FormView):
    ...
    success_url = reverse_lazy("ecommerce:adminhome")
...
class AdminOrderStatusChangeView(AdminRequiredMixin, View):
    def post(self, request, *args, **kwargs):
        ...
        order_obj.save()
        return redirect(reverse_lazy("ecommerce:adminorderdetail", kwargs={"pk": order_id}))
...
class KhaltiVerifyView(View):
    def get(self, request, *args, **kwargs):
        ...
        headers = {
            "Authorization": "Key test_secret_key_5293abc9cf044b8185884fca311fc048"
        }
...
class AdminProductCreateView(AdminRequiredMixin, CreateView):
    ...
    success_url = reverse_lazy("ecommerce:adminproductlist")
